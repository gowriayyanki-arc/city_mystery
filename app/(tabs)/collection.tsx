...
export default function CollectionScreen() {
  ...
  const completedCities = cities.filter((city) =>
    completedCityIds.has(city.id),
  );
      ...
      {completedCities.length > 0 ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>
            Play the game to discover cities and build your collection!
          </Text>
        </View>
      )}
      ...
      {lockedCount > 0 && (
        <View style={styles.lockedSection}>
          ...
          <Text style={styles.lockedText}>
            Keep playing to unlock more cities!
          </Text>
        </View>
      )}
    </ScrollView>
